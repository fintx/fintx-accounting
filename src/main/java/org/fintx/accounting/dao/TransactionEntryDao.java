...
public interface TransactionEntryDao {
	 ...
	 */
	List<TransactionEntry> differDetailDrCrAmtFromAcctDrCrAmt(@Param("acctTitleCode") String acctTitleCode, @Param("txnDate") String txnDate, @Param("acctNo") String acctNo);
